...
import { OFF_FORM_UPDATE } from '../../../redux/constant/userConstant'
...
export default function FormUpdateInfo() {
    ...
    const onFinish = (values) => {
      ...
      userService.putInfoUpdate(data)
      .then((res) => {
        setFormUpdateOff()
